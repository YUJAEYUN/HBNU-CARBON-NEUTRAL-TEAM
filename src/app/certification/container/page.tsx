  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="bg-white px-4 py-3 flex items-center justify-between shadow-sm z-20 relative">
        ...
        <h1 className="text-lg font-bold absolute left-1/2 transform -translate-x-1/2">다회용기 인증</h1>
        ...
        <div className="mb-6 bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="p-5 border-b border-gray-100">
            <div className="flex items-center mb-1">
              ...
              <h2 className="text-lg font-bold text-gray-800">다회용기 사용 효과</h2>
            </div>
            <p className="text-gray-500 text-sm">일회용 용기 대신 다회용기를 사용하면</p>
          </div>
          <div className="p-5 bg-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">탄소 절감량</p>
                <p className="text-2xl font-bold text-primary mt-1">0.25kg</p>
              </div>
              <div>
                <p className="text-gray-500 text-sm">획득 포인트</p>
                <p className="text-2xl font-bold text-primary mt-1">20P</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-5 mb-4">
            <div className="flex items-start mb-4">
              ...
              <div className="ml-3">
                <p className="font-medium text-gray-800">다회용기 사용 사진 촬영</p>
                <p className="text-gray-500 text-sm mt-1">다회용기에 음식을 담은 모습이 잘 보이도록 촬영해주세요.</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="font-medium text-gray-800">간단한 설명 작성</p>
                <p className="text-gray-500 text-sm mt-1">어떤 음식을 다회용기에 담았는지 간단히 설명해주세요.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-800">다회용기 사진</p>
              ...
              <div className="p-4 bg-gray-50">
                {image ? (
                  <div className="relative">
                    <img src={image} alt="다회용기 인증 사진" className="w-full h-64 object-contain rounded-lg" />
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
            <div className="p-4 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <p className="font-medium text-gray-800">간단한 설명</p>
              </div>
            </div>
            <div className="p-4">
              <textarea
                id="desc"
                placeholder="어떤 음식을 다회용기에 담았는지 설명해주세요"
                className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary min-h-[100px] text-gray-700"
                value={desc}
